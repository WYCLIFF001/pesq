...
/// where the per-band sum accumulates (spec 01, 1.1).
pub(super) const PITCH_POWER_SCALE: f64 = 2.764_344e-5;

/// Loudness scaling Sl (spec 03, 3.6 step 4). Applied in f64, where the
/// loudness is computed (spec 01, 1.1).
pub(super) const LOUDNESS_SCALE: f64 = 1.866_055e-1;
